...
export const RegisterPage = () => {
    ...
    const { mutate, isLoading, isSuccess, isError, error } = usePost( '/auth/local/signup', JSON.stringify( {
        user: {
    ...
    return (
        <div className={'border rounded-lg border-white max-w-5xl m-10 lg:m-20'}>
            <div className="flex items-center justify-center rounded-lg">
                ...
                <div className={'lg:w-1/2 lg:min-w-[430px] p-10'}>
                    <h1 className="lg:hidden flex items-center justify-center gap-2 mb-4">
                        <img src={rptLogo} alt="reptrack logo" className="h-12"/>
                        <span className="text-2xl font-medium text-green-500">Reptrack</span>
                    </h1>
                    {/* give the user a register success message with a success icon*/}
