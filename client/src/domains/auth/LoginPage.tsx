...
export const LoginPage = () => {
    ...
    const { mutate, isLoading, isError, error, isSuccess } = usePost( '/auth/local/login', JSON.stringify( {
        email: emailValue,
    ...
    return <div className='border rounded-lg border-white max-w-5xl m-10 lg:m-20'>
