...
const initialWorkoutState = {
  workouts: [
    ...
    },
    {
      ...
      name: 'Full-Body A',
      active: false,
      trainedAt: [new Date(-30000), new Date(-40000)],
      trainingInterval: 2,
      exercises: [],
      createdBy: 'MLNK',
      createdAt: new Date(),
    ...
    },
    {
      ...
      name: 'Legs A',
      active: true,
      trainedAt: [new Date(), new Date(-20000)],
      trainingInterval: 2,
      exercises: [],
      createdBy: 'MLNK',
      createdAt: new Date(),
    ...
    },
    {
      ...
      name: 'Legs A',
      active: true,
      trainedAt: [new Date(-50000), new Date(-50000)],
      trainingInterval: 2,
      exercises: [],
      createdBy: 'MLNK',
      createdAt: new Date(),
