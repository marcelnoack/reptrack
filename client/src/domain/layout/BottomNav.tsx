    ...
    <nav className='bottom-nav'>
      <ul className='nav-list'>
        ...
        <NavLink to='/workouts' activeClassName='route--active' className='route'>
          <li className={`nav-list__tab ${appState.mainAction.page ? 'nav-list__tab--curve-right' : ''}`}>
        ...
        <NavLink to='/progress' activeClassName='route--active' className='route'>
          <li className={`nav-list__tab ${appState.mainAction.page ? 'nav-list__tab--curve-left' : ''}`}>
